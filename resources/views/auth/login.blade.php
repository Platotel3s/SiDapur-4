    ...
    <body class="bg-linear-to-br from-black to-red-600 flex justify-center items-center min-h-screen">
        ...
        <div class="w-full max-w-md bg-white/10 border border-amber-600 rounded-2xl shadow-lg p-8">
            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-5">
                ...
                <div>
                    <label for="phone" class="block text-gray-100 font-medium mb-1">
                        Nomor Telepon
                    </label>
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            class="w-full pl-14 border border-gray-300 rounded-lg p-3
                            focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500
                            focus:outline-none transition text-gray-100 bg-transparent"
                            value="{{ old('phone') }}"
                            required
                        >
                    </div>
