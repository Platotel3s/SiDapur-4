...
<div class="min-h-screen py-6 sm:py-12 px-4">
    <div class="max-w-4xl mx-auto">
        <div class="text-center mb-8">
            <div class="inline-flex items-center justify-center w-20 h-20 bg-linear-to-r from-green-500 to-emerald-400 rounded-full mb-4">
        ...
        <div class="lg:hidden space-y-4">
            <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-yellow-500">
                <div class="flex items-center justify-between mb-4 pb-4 border-b border-yellow-500/50">
                    <div>
                        <h3 class="text-sm font-medium text-gray-400">Nomor Pesanan</h3>
                        <p class="text-xl font-bold text-white">{{ $order->order_number }}</p>
                    </div>
                    <span class="px-3 py-1 rounded-full text-xs font-semibold {{ $order->payment_status == 'paid' ? 'bg-green-900/50 text-green-300' : 'bg-red-900/50 text-red-300' }}">
                ...
                <div class="space-y-3">
                    ...
                    <div>
                        ...
                        <div class="mt-2 p-3 bg-gray-900/30 rounded-lg">
                            <p class="text-sm text-white mb-2">Silahkan transfer ke:</p>
                            <p class="text-sm font-semibold text-white">BCA: 1234567890 (PT SiDapur)</p>
                            <p class="text-sm font-semibold text-white mt-1">Mandiri: 0987654321 (PT SiDapur)</p>
                        </div>
                        @else
                        <p class="text-sm text-gray-300 mt-2">Pembayaran dilakukan setelah barang sampai</p>
                        @endif
                    </div>
            ...
            <div class="space-y-3">
                <a href="{{ route('customer.orders') }}"
                   class="block w-full bg-linear-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 text-white font-semibold py-4 px-6 rounded-xl transition duration-200 text-center">
        ...
        <div class="hidden lg:block bg-gray-900/50 backdrop-blur-sm rounded-2xl overflow-hidden border border-yellow-500">
            ...
            <div class="grid grid-cols-3 gap-8 p-8">
                    ...
                    <div class="bg-gray-800/30 rounded-xl p-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                @if ($order->payment_method == "transfer")
                                <div class="mt-3 p-4 bg-gray-900/30 rounded-lg">
                                    <p class="text-sm text-white mb-2">Silahkan transfer ke rekening:</p>
                                    <p class="text-sm font-semibold text-white">BCA: 1234567890 (PT SiDapur)</p>
                                    <p class="text-sm font-semibold text-white mt-1">Mandiri: 0987654321 (PT SiDapur)</p>
                                </div>
                                @else
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-3">
                        <a href="{{ route('customer.orders') }}"
                           class="block w-full bg-linear-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 text-white font-semibold py-3 px-6 rounded-xl transition duration-200 text-center">
                            <i class="fas fa-history mr-2"></i>
                            Lihat Riwayat
                        </a>
            ...
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-gray-300">
                        ...
                        ketika pesanan sudah dikirim. Estimasi pengiriman: 1-3 hari kerja.
                    </p>
                </div>
            </div>
        </div>
