    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 mb-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div class="flex-1">
                    <div class="relative">
                        <input type="text" placeholder="Cari order / customer..."
                    ...
                    <div class="space-y-3">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700">
                                {{ $order->alamat->namaPenerima ?? 'N/A' }}<br>
                                {{ $order->alamat->alamat ?? '-' }}
                            </p>
                        </div>
                ...
                <table class="w-full">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="py-4 px-2 text-left text-gray-700 font-semibold">Alamat</th>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50 transition duration-150">
                            ...
                            <td class="py-4 px-6">
                                <div>
                                    <p class="font-medium text-gray-900">{{ $order->alamat->namaPenerima ?? 'N/A' }}</p>
...
<div id="confirmModal" class="hidden fixed inset-0 bg-gray-900 bg-opacity-50 z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-xl p-6 w-full max-w-md">
        <h3 class="text-lg font-bold mb-4">Konfirmasi Pembayaran</h3>
        <p class="text-gray-600 mb-6">Apakah Anda yakin ingin menandai pembayaran ini sebagai LUNAS?</p>
